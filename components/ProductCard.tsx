...
const ProductCard = ({data}:ProductCardProps)=>{
    ...
    return (
        <div onClick={HandleClick} className="bg-white group space-y-4 cursor-pointer rounded-xl border p-3 mb-10">
            <div className="aspect-square bg-gray-100 rounded-xl relative">
                ...
                <div className="opacity-0 group-hover:opacity-100 transition absolute px-6 bottom-5 w-full">
                    <div className="flex gap-x-6 justify-center">
                        ...
                        <IconButton onClick={AddToCart} icon={<ShoppingCart size={20} className="text-gray-600" />}/>
                    </div>
                </div>
            </div>
            <div>
